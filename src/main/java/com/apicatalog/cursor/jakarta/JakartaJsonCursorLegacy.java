...
public class JakartaJsonCursorLegacy {
...
//
//    @Override
//    public ArrayCursor array(final String property) {
//        if (!isArray(property)) {
//            throw new IllegalArgumentException();
//        }
//    
...
//
//    @Override
//    public MapCursor object(final String property) {
...
//
//    @Override
//    public Cursor value(final String property) {
//        if (!isObject()) {
//            throw new IllegalArgumentException();
//        }
//    
